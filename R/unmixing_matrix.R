...
#'   "AutoSpectral", "Spectreasy", or "TRU_Spectreasy"). Static
#'   `"AutoSpectral"`, `"Spectreasy"`, and `"TRU_Spectreasy"` exports use the
#'   OLS solver proxy.
...
derive_unmixing_matrix <- function(M,
    ...
    if (method_solver == "OLS") {
        ...
        stop("method must be one of: 'AutoSpectral', 'Spectreasy', 'TRU_Spectreasy', 'OLS', 'WLS', 'RWLS', 'NNLS'")
    }
